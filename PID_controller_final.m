...
wheel_moi = [.00000523 0 0; 0 .0000523 0; 0 0 .00000523]; %reaction wheel moment of inertia
...
while T < TIME
    %PID Controller
        int = sum(quat_err_list, 2)*dt; %integral term adds the error as it accumulates

        ang_acc = Kp*quat_err(2:4) + Ki*int(2:4) + Kd*ang_vel; %angular acceleration based on PID components
